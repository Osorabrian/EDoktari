...
<body> 
    <?php  
                  ...
                  $sql = "SELECT profileimage, firstname, lastname, email, phonenumber, address, height, weight, gender FROM patients WHERE email = '$email'";
                ...
                <div class="row align-items-center flex-row-reverse">
                    <div class="col-lg-6">
                        <div class="about-text go-to">
                            ...
                            <h6 class="theme-color lead">Personal Information</h6>
                            <div class="row about-list">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="media">
                                        <label>Height</label>
                                        <p><?php echo $row['height'] ?> cm.</p>
                                    </div>
                                    <div class="media">
                                        <label>Weight</label>
                                        <p><?php echo $row['weight'] ?> Kgs.</p>
                                    </div>
                                   
                                    
                                </div>
                             </br>
                            <a href="patient_profile.php" class="btn btn-primary float-right ">Edit Profile</a>
                    ...
                    <div class="col-lg-6">
                        <div class="about-avatar">
                            <img src="patientprofilepictures/<?php echo $row['profileimage'] ?>" >
                        </div>
                    </div>
                </div>
