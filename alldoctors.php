...
<?php
    ...
    ?>
          ...
          <tr>
            <td class="table-light"><?php  echo $row['doctor_id'];?></td>
            ...
            <td class="table-light"><?php  echo $row['uniquenumber'];?></td>
            <td class="table-light"><?php  echo $row['dateofbirth'];?></td>
            <td class="table-light"><?php  echo $row['officeaddress'];?></td>
            <td class="table-light"><?php  echo $row['gender'];?></td>
            <td class="table-light"><?php  echo $row['type'];?></td>
            <td class="table-light"><?php  echo $row['country'];?></td>
			<td>
            <a href="deletedoctors.php?doctor_id=<?php echo $row["doctor_id"]; ?>" class="btn btn-danger" onclick="return confirm('Are you sure to delete?');">delete</a>
			</td>
          </tr>
