   ...
   <div class="container mt-5">
        <?php foreach($query as $q){ ?>
            <form method="POST">
                ...
                <img src="<?php echo $q['img_dir'] ?>" alt="Trulli" id="profileImage" width="500" height="333">
                </br>
              
                <input type="file" class="form-control"  id="imageUpload" name = 'image' value="<?php echo $q['image_dir']?>"></br>
