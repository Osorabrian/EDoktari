...
<?php
    ...
    ?>
          ...
          <tr>
            ...
            <td class="table-light"><?php  echo $row['patientemail'];?></td>
            <td class="table-light"><?php  echo $row['card_holder'];?></td>
            <td class="table-light"><?php  echo $row['card_num'];?></td>
            <td class="table-light"><?php  echo $row['currency'];?></td>
            <td class="table-light"><?php  echo $row['paid_amount'];?></td>
            <td class="table-light"><?php  echo $row['created'];?></td>
			<td>
            <a href="deletepayments.php?id=<?php echo $row["id"]; ?>" class="btn btn-danger" onclick="return confirm('Are you sure to delete?');">delete</a>
			</td>
          </tr>
