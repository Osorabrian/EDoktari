...
<?php
                $email = $_SESSION['email'];
                $sql = "SELECT * FROM appointment WHERE doctoremail ='$email' and status = 'Approved'";
    ...
    ?>
          ...
          <tr>
			...
			<td>
          <a href="doctorvirtual.php?appointment_id=<?php echo $row["appointment_id"]; ?>" class="btn btn-primary">Meet</a>
            <a href="doctoreditappointments.php?appointment_id=<?php echo $row["appointment_id"]; ?>" class="btn btn-warning">edit</a>
